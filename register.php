...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (strpos($email, '@gmail.com') === false) {
        ...
        if ($stmt->execute([$username, $email, $phone, $password])) {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'sidharthkv.app@gmail.com'; // Sender's email address
            $mail->Password = 'swfs qojj wifh cglj'; // Sender's app password
            $mail->SMTPSecure = PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            $mail->setFrom('sidharthkv.app@gmail.com', 'Website.sidh');
